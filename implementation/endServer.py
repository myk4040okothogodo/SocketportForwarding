...
def ConnectionSetup():
    while True:
        if check is True:
            ...
            color_print("\n[!] receiving packets from screenin server.....", color="green", bold=True)
            ...
            if tmpHash == clientPublicHash:
                ...
                color_print("\n[!] Forwarding servers' public key and public key hash matches\n", color="blue")
                ...
                if clientPH != "":
                    ...
                    if clientPH == eightByte:
                        ...
                        color_print("\nSession key from forwarding/Screening server server doesnt match", color="red", underline=True)
...
if __name__ == "__main__":
    ...
    check = False
    color_print("Connecting with forwarding server",  color="blue", bold=True)
    host = 'localhost'
    port = 8088
